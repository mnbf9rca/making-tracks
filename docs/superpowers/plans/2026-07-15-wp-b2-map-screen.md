...
- **Hidden/category filter ruling (Rob, 2026-07-18).** Hidden + category filters compose: show-hidden re-adds hidden pins to the source, but category predicates still apply.
