...
- **Status:** ready-to-merge — [#518](https://github.com/mnbf9rca/making-tracks/pull/518); Opus review clean at `fa3206b3613a17202b426329eb2a1dacf3fbec08`; Sourcery posted with no actionable feedback (weekly quota exhausted); implementation and adversarial-review head `7664571fea7810fa0c3d492dcba962bb21f2ec45`; Release build; 474 host tests, 215 app tests and 81 UI tests, 0 failures; fable owns merge
