...
- **#579 — atomic-publish test/API skew on `ios`**, claimed by codex3 on `fix-579-atomic-publish`; the clean-`ios` reproduction is 3 failed, 695 passed, 1 skipped.
...
| **#579** — atomic-publish test/API skew | codex3 | `fix-579-atomic-publish` |
