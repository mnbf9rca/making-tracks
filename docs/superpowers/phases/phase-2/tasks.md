...
- **Evidence:** integrated head `6fecc6a`; `cd ios && swift test` — 501 tests, 0 failures; locked codex3 release gate — Release + debug builds green, 319 simulator tests, 0 failures (86 UI tests); six inspected default/AX implementation renders recorded in the design-system README.
