...
- **Status:** branch — resumed after W-1 merged; rebased onto `4e6f09d`; icon-role RED→GREEN complete, scaled-inset test held at RED pending the macOS host-evidence route
