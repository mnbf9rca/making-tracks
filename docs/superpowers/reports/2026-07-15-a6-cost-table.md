...
nous-deepseek-v4-pro-low	nous	41786	256	0.05336667	byte-estimate
nous-deepseek-v4-pro-high	nous	41786	256	0.05336667	byte-estimate
...
Round 1b adds S5-S7 with the same 256-token cap precedent:
`deepseek/deepseek-v4-pro`, `z-ai/glm-5.2`, and `meta/muse-spark-1.1`. AMQ handoff `2026-07-16T13-34-45.850Z_pid54913_e454708c`
...
The default reasoning posture is off/minimal; DeepSeek is represented as three
cache-distinct variants (`none`, `low`, `high`) to measure whether reasoning effort
buys AUC on this task.
