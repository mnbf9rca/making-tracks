...
| Asset | What it shows |
|---|---|
| `t2.10-about{,-ax}.png` + `t2.10-{software,data}-licences{,-ax}.png` | T2.10 runtime UI-test evidence for the W-2 About rebuild on the Snow surface. The default and accessibility-size captures show the story and privacy hierarchy plus separate native Software licences and Data licences destinations. The destination captures preserve the shipped GRDB.swift, MapLibre, Newsreader, Noto Sans, OpenStreetMap, and runtime attribution inventory; the AX captures demonstrate wrapping and scrollable legal text without overlap or clipped navigation controls. Exported from the locked codex3 simulator by the two re-pointed About UI tests. SHA-256: `e881678216444e8d62577b1cf72fad6640ef5b2e6d885de4834e0b37ecb9f57b` (About), `5c13cc353b0c0bae255f1355f4e4feeb32ad1e13e72f73e6b0a82a4158459f01` (Software), `8b325351a88becd25cf5f86c24f96c2ace5fc811ccc2927b2a1f1f1bb2755372` (Data), `5a504d3cd15b1e705f42f286bda7645466ce28db15dd82fdb39cd05a68c62b14` (About AX), `374cf0bef5b9456011d2c69cff05eb872fcaf5f8c5e7e43d012d8b6bad37927a` (Software AX), and `9a353a70a5262da56a356f7ff9f8ac9960237757248dbfd7a3be6b4b5549e1c3` (Data AX). |
