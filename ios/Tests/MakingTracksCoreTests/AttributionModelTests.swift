...
final class AttributionModelTests: XCTestCase {
    func testCreditsRenderManifestAttributionVerbatim() {
        let attribution = [
            ...
            Attribution(source: "historic_england", license: "OGL-3.0", text: "Contains Historic England data under the Open Government Licence v3.0."),
        ...
        XCTAssertEqual(model.credits.map(\.license), ["ODbL-1.0", "OGL-3.0", "PDDL-1.0"])
    }
